...
public class Vista {
	...
	private void initialize() {
		...
		l.playMusic(Vista.class.getResource("/paquete/cancion.wav"));
        l.usarDB();
		...
		betis.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				v2 = new Vista_Ventana(c, "betis.jpg", "Betis" );
			}
		});
        ...
        Play.setIcon(new ImageIcon(Vista.class.getResource("/paquete/play.png")));
        Play.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		l.resumeMusic();
        	}
        });
        Play.setBounds(554, 503, 30, 30);
        frmLigaSantander.getContentPane().add(Play);
        
        JButton Stop = new JButton("");
        Stop.setBackground(Color.WHITE);
        Stop.setIcon(new ImageIcon(Vista.class.getResource("/paquete/pausa.png")));
        Stop.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		l.stopMusic();
        	}
        });
        Stop.setBounds(608, 503, 30, 30);
        frmLigaSantander.getContentPane().add(Stop);
        
        JButton subir = new JButton("");
        subir.setBackground(Color.WHITE);
        subir.setIcon(new ImageIcon(Vista.class.getResource("/paquete/subir.png")));
        subir.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		l.increaseVolume(3.0f);
        	}
        });
        subir.setBounds(689, 490, 30, 30);
        frmLigaSantander.getContentPane().add(subir);
        
        JButton bajar = new JButton("");
        bajar.setBackground(Color.WHITE);
        bajar.setIcon(new ImageIcon(Vista.class.getResource("/paquete/bajar.png")));
        bajar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		l.decreaseVolume(3.0f);

        	}
        });
        bajar.setBounds(689, 523, 30, 30);
        frmLigaSantander.getContentPane().add(bajar);
